...
var createNestedLinks = function createNestedLinks(children) {
  ...
  var links = React.Children.toArray(children).reduce(function (acc, child) {
...
var flattenLinks = function flattenLinks(children) {
  return React.Children.toArray(children).reduce(function (acc, child) {
    ...
    if (!child.props || !child.props.children) { return acc; }
    return React.Children.toArray([].concat(_toConsumableArray(acc), _toConsumableArray(flattenLinks(child.props.children))));
  }, []);
};

var Sidenav = React.forwardRef(function (_ref2, ref) {
  var open = _ref2.open,
  ...
  }, open && jsx(Overlay, props), jsx(MDXProvider, {
...
var AccordionNav = React.forwardRef(function (_ref4, ref) {
  var open = _ref4.open,
  ...
  return jsx("div", null, open && jsx(Overlay, props), jsx("div", {
    ref: ref,
    className: className,
    sx: {
      position: ['fixed', 'sticky'],
    ...
    return jsx("li", {
      ...
      children: link.props.children,
      className: link.props.className
    }), link.props.links && jsx(AccordionButton, {
      href: link.props.href,
      pathname: pathname,
      open: expanded[i],
      sx: {
      ...
      onClick: toggle(i)
    })), jsx(NavLinks, _extends({}, link.props, {
      open: expanded[i],
      pathname: pathname,
      Link: Link
    })));
...
var Pagination = function Pagination(_ref6) {
  ...
  }), hasPagination && previous && jsx(PaginationLink, _extends({}, previous.props, {
    label: "Previous:"
  })), jsx("div", {
    sx: {
      mx: 'auto'
    }
  }), hasPagination && next && jsx(PaginationLink, _extends({}, next.props, {
    label: "Next:"
  })));
};

export { Sidenav, AccordionButton, AccordionNav, Pagination };
